...
export type IconName = "plus" | "arrowUp" | "stop" | "copy" | "redo" | "pencil" | "check" | "chevron" | "sidebar" | "inspector" | "close" | "compose" | "gear" | "expand" | "collapse";
...
export function icon(name: IconName): SVGElement {
  const paths: Record<string, string> = {
    ...
    sidebar: "M2.5 3.5h11a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1h-11a1 1 0 0 1-1-1v-7a1 1 0 0 1 1-1zM6 3.5v9",
    inspector: "M2.5 3.5h11a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1h-11a1 1 0 0 1-1-1v-7a1 1 0 0 1 1-1zM10 3.5v9",
    ...
    compose: "M8.5 3H4.2A1.2 1.2 0 0 0 3 4.2v7.6A1.2 1.2 0 0 0 4.2 13h7.6a1.2 1.2 0 0 0 1.2-1.2V7.5M11.6 2.4l2 2-5.4 5.4-2.5.5.5-2.5z",
  ...
  p.setAttribute("fill", name === "stop" || name === "gear" ? "currentColor" : "none");
...
export function formatTokens(n: number): string {
  return n >= 10_000 ? `${(n / 1000).toFixed(n >= 100_000 ? 0 : 1)}k` : String(n);
}
...
export function debounceFrame<T extends unknown[]>(fn: (...args: T) => void): (...args: T) => void {
  let pending = false;
  let last: T;
  return (...args: T) => {
    last = args;
